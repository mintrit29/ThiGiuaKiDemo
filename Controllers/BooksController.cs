...
using ThiGiuaKiDemo.Data;
using ThiGiuaKiDemo.Models;

namespace ThiGiuaKiDemo.Controllers
{
    public class BooksController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("BookId,Title,Description,CoverImagePath,AuthorId")] Book book)
        {
